...
class TestForgeApp:
    ...
    def test_security_policy_hides_command_introspection(self, tmp_path: Path) -> None:
        ...
        assert (
            response["error"]
            == "Command not allowed by security policy: '__forge_describe_commands'"
        )
    ...
    def test_built_in_apis_are_exposed_on_app_instance(self, tmp_path: Path) -> None:
        ...
        response = json.loads(
            app.bridge.invoke_command(json.dumps({"command": "version", "args": {}, "id": 4}))
        )
        assert response["error"] is None
        ...
        response = json.loads(
            app.bridge.invoke_command(
                json.dumps({"command": "list", "args": {"path": "."}, "id": 5})
            )
        )
        assert response["error"] is None
    ...
    def test_menu_api_manages_menu_state_and_emits_events(self, tmp_path: Path) -> None:
        config_path = _write_config(tmp_path, permissions="[permissions]\nmenu = true\n")
        app = ForgeApp(str(config_path))
    ...
    #     def test_notification_api_records_delivery_and_emits_event(self, tmp_path: Path, monkeypatch) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #         received: list[dict[str, object]] = []
    #
    ...
    #         )
    #         monkeypatch.setattr("forge.api.notification.subprocess.run", lambda *args, **kwargs: None)  # noqa: E501
    #
    ...
    #
    #         response = json.loads(
    #             app.bridge.invoke_command(json.dumps({"command": "read", "args": {"path": "x"}, "id": 3}))  # noqa: E501
    #         )
    ...
    #         assert any(item["name"] == "__forge_runtime_health" for item in diagnostics["commands"])  # noqa: E501
    ...
    #         logs = json.loads(
    #             app.bridge.invoke_command(
    #                 json.dumps({"command": "__forge_runtime_logs", "args": {"limit": 5}, "id": 34})  # noqa: E501
    #             )
    #         )
    ...
    #         assert any(item["name"] == "__forge_runtime_diagnostics" for item in commands["result"])  # noqa: E501
    #         assert protocol["error"] is None
    #         assert protocol["result"]["current"] == "1.0"
    ...
    #             app._record_crash(type(exc), exc, exc.__traceback__, thread_name="test-thread", fatal=True)  # noqa: E501
    #
    ...
    #         ]
    #
    #     def test_window_ready_navigates_to_configured_dev_server(self, tmp_path: Path, monkeypatch) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    ...
    #
    #     def test_runtime_control_ipc_commands_and_support_bundle_export(self, tmp_path: Path) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #         proxy = self._FakeWindowProxy()
    #         app._on_window_ready(proxy)
    ...
    #         for payload in [
    #             {"command": "__forge_runtime_navigate", "args": {"url": "https://forge.dev"}, "id": 35},  # noqa: E501
    ...
    #         assert any(item["name"] == "__forge_runtime_export_support_bundle" for item in registry)  # noqa: E501
    #
    #     def test_support_bundle_includes_crash_snapshot_when_present(self, tmp_path: Path) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #
    #         try:
    ...
    #         except ValueError as exc:
    #             app._record_crash(type(exc), exc, exc.__traceback__, thread_name="bundle-thread", fatal=False)  # noqa: E501
    #
    ...
    #         ).decode("utf-8")
    #         manifest_path.write_text(json.dumps(manifest, indent=2, sort_keys=True), encoding="utf-8")  # noqa: E501
    #
    ...
    #         assert (Path(apply_result["backup_dir"]) / "app.txt").read_text(encoding="utf-8") == "old version"  # noqa: E501
    #         assert update_result["updated"] is True
    #         assert update_result["check"]["signature_verified"] is True
    #
    #         verify_response = json.loads(
    #             app.bridge.invoke_command(
    #                 json.dumps({"command": "updater_verify", "args": {"manifest_url": str(manifest_path)}, "id": 45})  # noqa: E501
    #             )
    #         )
    ...
    #         assert "Unknown command" in response["error"]
    #
    #     def test_window_api_updates_initial_config_before_runtime_ready(self, tmp_path: Path) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #
    ...
    #
    #     def test_window_api_dispatches_runtime_commands_once_proxy_is_ready(self, tmp_path: Path) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #         proxy = self._FakeWindowProxy()
    #
    ...
    #         ]
    #
    #     def test_window_runtime_only_operations_fail_before_window_is_ready(self, tmp_path: Path) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    #
    #         try:
    ...
    #
    #         for payload in [
    #             {"command": "__forge_window_set_title", "args": {"title": "Bridge Title"}, "id": 11},  # noqa: E501
    #             {"command": "__forge_window_set_position", "args": {"x": 222, "y": 333}, "id": 111},  # noqa: E501
    #             {"command": "__forge_window_set_size", "args": {"width": 1280, "height": 720}, "id": 12},  # noqa: E501
    #             {"command": "__forge_window_set_fullscreen", "args": {"enabled": True}, "id": 13},
    #             {"command": "__forge_window_set_always_on_top", "args": {"enabled": True}, "id": 14},  # noqa: E501
    ...
    #             {"command": "__forge_window_set_vibrancy", "args": {"effect": "sidebar"}, "id": 99},  # noqa: E501
    ...
    #
    #         app._on_window_ready(proxy)
    #         created = app.windows.create(label="settings", route="/settings", width=900, height=640)  # noqa: E501
    #
    ...
    #
    #     def test_run_uses_positional_native_window_args(self, tmp_path: Path, monkeypatch) -> None:  # noqa: E501
    #         config_path = _write_config(tmp_path)
    #         app = ForgeApp(str(config_path))
    ...
    #                 captured["ran"] = True
    #
    #         monkeypatch.setitem(sys.modules, "forge.forge_core", types.SimpleNamespace(NativeWindow=FakeNativeWindow))  # noqa: E501
    #
    #         app.run()
    #
    ...
    def test_production_runtime_defaults_disable_devtools_and_uses_hardened_csp(
    ...
    def test_security_allow_devtools_override_enables_devtools(
        self, tmp_path: Path, monkeypatch
    ) -> None:
        monkeypatch.setenv("FORGE_ENV", "production")
        config_path = _write_config(
    ...
    def test_runtime_devtools_methods_reject_when_disabled(
        self, tmp_path: Path, monkeypatch
    ) -> None:
        monkeypatch.setenv("FORGE_ENV", "production")
        config_path = _write_config(tmp_path)
        ...
        started = json.loads(
            app.bridge.invoke_command(
                json.dumps(
                    {
                        "command": "task_start",
                        "args": {"name": "heartbeat", "interval": 0.01},
                        "id": 301,
                    }
                )
            )
